public class Warmup1 {
    ...
    public boolean posNeg(int a, int b, boolean negative) {
        if ((negative == true && a < 0 && b < 0) || (negative == false && a * b < 0)) {
            return true;
        }
        return false;
    }
        ...
        if (str.length() >= 3) {
            return str.substring(0, 3)
                    .concat(str.substring(0, 3)
                            .concat(str.substring(0, 3))); //the inception
        }
    ...
    public String backAround(String str) {
        ...
        return str.substring(length - 1, length)
                .concat(str.concat(str.substring(length - 1, length)));
    }
    ...
    public boolean icyHot(int temp1, int temp2) {
        if (Math.min(temp1, temp2) < 0 && Math.max(temp1, temp2) > 100) {
            return true;
        }
        return false;
    }
    ...
    public boolean in3050(int a, int b) {
        boolean p = ((a >= 30 && a <=40) && (b >=30 && b <= 40));
        boolean q = ((a >= 40 && a <=50) && (b >=40 && b <= 50));
        if (p || q) {
            return true;
        }
        return false;
    ...
    public String endUp(String str) {
        ...
        return str.substring(0, sizeWord -3)
                .concat(str.substring(sizeWord - 3, sizeWord).toUpperCase());
    }
